...
<body>
    ...
    <section class="contributors" id="contribution">
        ...
        <div class="concard">
            <img src="https://github.com/pawarspeaks.png" alt="profile-picture" class="pfp">
            <div class="text">
                <h1>Pratap Pawar</h1>
            </div>
            <div class="logolink">
                <a href="https://github.com/pawarspeaks" target="_blank"><img src="img/GitHub120px.png"
        ...
        <div class="concard">
            <img src="https://github.com/Aditya-Mohite.png" alt="profile-picture" class="pfp">
            <div class="text">
                <h1>Aditya Mohite</h1>
            </div>
            <div class="logolink">
                <a href="https://github.com/Aditya-Mohite" target="_blank"><img src="img/GitHub120px.png"
                        alt="Github-Logo" class="github-logo"></a>
            </div>
        </div>

        <div class="concard">
            <img src="https://github.com/Yashraj49.png" alt="profile-picture" class="pfp">
            <div class="text">
                <h1>Yashraj Jadhav</h1>
            </div>
            <div class="logolink">
                <a href="https://github.com/Yashraj49" target="_blank"><img src="img/GitHub120px.png" alt="Github-Logo"
                        class="github-logo"></a>
            </div>
        </div>

        <div class="concard">
            <img src="https://github.com/Ganeshthepro.png" alt="profile-picture" class="pfp">
            <div class="text">
                <h1>Ganesh Navale</h1>
            </div>
            <div class="logolink">
                <a href="https://github.com/Ganeshthepro" target="_blank"><img src="img/GitHub120px.png" alt="Github-Logo"
                        class="github-logo"></a>
            </div>
        </div>

        <div class="concard">
            <img src="https://github.com/Aayush20031.png" alt="profile-picture" class="pfp">
            <div class="text">
                <h1>Aayush Kudalkar</h1>
            </div>
            <div class="logolink">
                <a href="https://github.com/Aayush20031" target="_blank"><img src="img/GitHub120px.png"
                        alt="Github-Logo" class="github-logo"></a>
            </div>
        </div>
